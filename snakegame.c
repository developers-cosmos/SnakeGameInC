// It is used to generate random values in the code
#include <ctime> 
// It means Double ended queue
#include <deque> 
#include <GL/glut.h>
// It is your course entry point to various constant, type and function declaration 
#include <unistd.h> 
#include <stdlib.h>
...
int main(int argc, char** argv){
    ...
    MessageBox(NULL,"GAME IS GOING TO START","SNAKE GAME",0);
